...
AI 招聘网站原型，面向求职者与招聘方提供一体化招聘工作台。当前版本已经从纯前端演示升级为带 Express API 与本地 JSON 数据持久化的全栈原型。

## 功能

- 账号体系：求职者/招聘方登录、注册、角色权限隔离。
- 求职者端：简历上传、PDF/DOCX/TXT 解析、简历亮点编辑、岗位搜索、城市/部门/技能筛选、AI 匹配分、投递记录。
